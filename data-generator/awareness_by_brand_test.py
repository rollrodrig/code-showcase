...
from ...fake_data.generator.prepost.awareness_by_brand_fakes import FAKES_CATEGORY_USAGE
from ...fake_data.generator.prepost.awareness_by_brand_fakes import FAKES_WAVES_USERS
from ...fake_data.generator.prepost.awareness_by_brand_fakes import FAKES_WAVES_USERS_COUNT
from ...fake_data.generator.prepost.awareness_by_brand_fakes import FAKES_BRAND_FRANCHISE_USERS
from ...fake_data.generator.prepost.awareness_by_brand_fakes import FAKES_BRAND_FRANCHISE_USERS_HEAVY
from ...fake_data.generator.prepost.awareness_by_brand_fakes import FAKES_BRAND_FRANCHISE_USERS_MEDIUM
from ...fake_data.generator.prepost.awareness_by_brand_fakes import FAKES_BRAND_FRANCHISE_USERS_LIGHT
from ...fake_data.generator.prepost.awareness_by_brand_fakes import FAKES_OPTION_NAMES
from ...fake_data.generator.prepost.awareness_by_brand_fakes import FAKES_OPTION_IDS
from ...fake_data.generator.prepost.awareness_by_brand_expects import EXPECTED_OPTION_IDS
from ...fake_data.generator.prepost.awareness_by_brand_expects import EXPECTED_BF_PRE_USER_COUNT
from ...fake_data.generator.prepost.awareness_by_brand_expects import EXPECTED_BF_POST_USER_COUNT
from ...fake_data.generator.prepost.awareness_by_brand_expects import EXPECTED_BF_PRE_USERS
from ...fake_data.generator.prepost.awareness_by_brand_expects import EXPECTED_BF_POST_USERS
from ...fake_data.generator.prepost.awareness_by_brand_expects import EXPECTED_WAVE_PRE_INVERTED
from ...fake_data.generator.prepost.awareness_by_brand_expects import EXPECTED_WAVE_POST_INVERTED
from ...fake_data.generator.prepost.awareness_by_brand_expects import EXPECTED_DATA
...
# python -m unittest discover backend.apps.popresearch.cmix.reporting.bsm.chart_generators.prepost awareness_by_brand_test.py
class AwarenessByBrandTestCase(unittest.TestCase):
    ...
    def test_should_init_class(self):
        ...
        r = AwarenessByBrand(waves, brand_franchise)
